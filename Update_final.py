...
def FTPto(folders, file):
    ...
    try:
        ...
        messagebox.showerror("Connection Error", "Check host, username and password input fields")
...
# FTPfolders - array of folders located on the server, that represent an absolute path of the directory, where .CSV file need to be sent to.
def encapsulation(jsonFile, csvFILE, FTPfolders):
...
server_path.insert(0,'clickandbuilds,Bcausam,wp-content,themes,astra')
